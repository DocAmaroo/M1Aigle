...
INSERT INTO Joueurs(id_joueur, nom, prenom, pseudo, solde, type, email, date_naissance, age, adresse, ville, pays, forme_monetaire, haut_fait, coord_bancaire) VALUES
(1, 'Canta', 'Thomas', 'Thominou', 250.21, 0, 'thomas.canta@etu.umontpellier.fr', TO_DATE('1998/09/28', 22, 'yyyy/mm/dd'), '250 avenue des amandiers',  'Montpellier', 'France', 'Euros', 'Debutant', 'FR81385041350');
INSERT INTO Joueurs(id_joueur, nom, prenom, pseudo, solde, type, email, date_naissance, age, adresse, ville, pays, forme_monetaire, haut_fait, coord_bancaire) VALUES
