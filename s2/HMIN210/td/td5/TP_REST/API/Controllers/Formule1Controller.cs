...
namespace API.Controllers
{
    ...
    [ApiController]
    public class Formule1Controller : ControllerBase
    {
        private static readonly MockDatabase db = new MockDatabase();
        private static readonly AgenceModel agence = new AgenceModel("Formule1", 0.985);
        ...
        // GET: api/Formule1/Offres/Filter
        ...
        public string GetOffres(string ville, int nbPersonne, string dateDebut, string dateFin, int nbEtoile)
        {
            ...
            // --- On applique le tarif propre, ici global à l'aide d'un pourcentage (-0.15%), de l'agence
