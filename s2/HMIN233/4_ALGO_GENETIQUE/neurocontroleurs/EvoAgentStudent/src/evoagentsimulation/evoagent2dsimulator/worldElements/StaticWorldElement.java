...
public class StaticWorldElement extends WorldElement{
	public StaticWorldElement(Vec2 worldPos, float worldAng,float s)
	{
		super(worldPos, worldAng, s);
		sd = new FixtureDef();
		sd.filter.categoryBits = CollisionDefines.CDEnv;
		sd.filter.maskBits = CollisionDefines.CDAllButEnvMask;
		bd = new BodyDef();
