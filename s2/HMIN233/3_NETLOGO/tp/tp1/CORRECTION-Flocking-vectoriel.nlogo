...
to go
  ask flockers [
    ifelse color = green and any? disruptors in-radius vision-orange
    [wiggle]
    [ ifelse use-vector?
      [flock-vector]
      [flock]
...
to-report average-flockmate-heading  ;;trouver l'orientation moyenne des voisins
  ;; a cause du system de coordonnes de netlogo, cela requiere un calcul special
...
to-report average-heading-towards-flockmates
  ;; trouver l'orientation moyenne vers les voisins (barycentre)
  ;;
