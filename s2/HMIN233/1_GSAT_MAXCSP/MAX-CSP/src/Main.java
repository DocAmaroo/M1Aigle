...
public class Main {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.println("Nombre de couleur au départ: " + graph.getNbColors() + "\n");
        graph.recuitSimule();
        System.out.println("\n[+]Nombre de couleurs minimum trouvé: " + graph.getNbColors());
        System.out.println("NB: Chaque entier représente une couleur et l'indice l'id du noeud");
