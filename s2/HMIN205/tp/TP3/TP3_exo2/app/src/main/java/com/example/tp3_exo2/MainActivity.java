...
public class MainActivity extends AppCompatActivity {
    ...
    public void onSubmit(View v) {
        ...
        try {
            ...
            file.write(this.userNameEntry.getText().toString().getBytes());
            file.write(newLine.getBytes());
            file.write(this.userFirstNameEntry.getText().toString().getBytes());
            file.write(newLine.getBytes());
            file.write(this.userPhoneEntry.getText().toString().getBytes());
            file.write(newLine.getBytes());
            file.close();
