...
public class requete1 {
    ...
    private static String OUTPUT_PATH = "input-tmp/req1Join-";
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            // on Inscription -> idDate,idPromotion,idEvent,idJoueur,PrixInscription,Gain
                ...
                if(!words[0].equals("idDate"))
                    context.write(new Text(words[0]), new Text("|"+words[5]));
            }
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setMapperClass(requete1.Map.class);
        job.setReducerClass(requete1.Reduce.class);
        ...
        job2.setMapperClass(requete1.Map.class);
