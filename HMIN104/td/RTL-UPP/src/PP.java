...
class PPInv extends PPUnOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr ne = this.e.toUPP(locals);
...
class PPLt extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr ue1 = this.e1.toUPP(locals);
        UPPExpr ue2 = this.e2.toUPP(locals);
        return new UPPLt(ue1, ue2);
    }//toUPP
...
class PPArrayGet extends PPExpr {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr array = this.arr.toUPP(locals);
        UPPExpr i = this.index.toUPP(locals);
        UPPExpr res = new UPPAdd(array, new UPPMul(new UPPCte(4), i));
        return new UPPLoad(res);
    }//toUPP
...
class PPArraySet extends PPInst {
    ...
    UPPInst toUPP(ArrayList<String> locals) {
        UPPExpr array = this.arr.toUPP(locals);
        UPPExpr i = this.index.toUPP(locals);
        UPPExpr value = this.val.toUPP(locals);

        UPPExpr res = new UPPAdd(array, new UPPMul(new UPPCte(4), i));
        return new UPPStore(res, value);
    }//toUPP
...
class PPWhile extends PPInst {
    ...
    UPPInst toUPP (ArrayList<String> locals) {
        UPPExpr ncond = this.cond.toUPP(locals);
        UPPInst inst = this.i.toUPP(locals);
        return new UPPWhile(ncond, inst);
    }//toUPP
...
class PPProcCall extends PPInst {
    ...
    UPPInst toUPP (ArrayList<String> locals) {
        ...
        return new UPPProcCall(this.callee, nargs);
    }//toUPP
...
class PPProc extends PPDef {
    ...
    UPPDef toUPP () {
        ArrayList<String> nargs = new ArrayList<String>();
        for (Pair<String,Type> p : args){ nargs.add(p.left); }

        ArrayList<String> nlocals = new ArrayList<String>();
        for (Pair<String,Type> p : locals){ nlocals.add(p.left); }

        UPPInst ncode =this.code.toUPP(nlocals);
