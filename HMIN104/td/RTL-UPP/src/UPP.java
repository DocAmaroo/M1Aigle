...
class UPPNot extends UPPUnOp {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
        ...
        RTLInst xori = new RTLXOri(regIn, reg, succ);
...
class UPPAnd extends UPPBinOp {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, PRegister reg, RTLInst succ) {
        PRegister regIn1 = this.e1.getPRegister(locals);
        PRegister regIn2 = this.e2.getPRegister(locals);
        RTLInst and = new RTLAnd(regIn1, regIn2, reg, succ);
        RTLInst ne2 = this.e2.toRTL(locals, globals, regIn2, and);
        return this.e1.toRTL(locals, globals, regIn1, ne2);
    }//toRTL
...
class UPPOr extends UPPBinOp {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
        ...
        PRegister regIn1 = this.e1.getPRegister(locals);
        PRegister regIn2 = this.e2.getPRegister(locals);
        RTLInst or = new RTLOr(regIn1, regIn2, reg, succ);
        RTLInst ne2 = this.e2.toRTL(locals, globals, regIn1, or);
        return this.e1.toRTL(locals, globals, regIn1, ne2);
    }//toRTL
...
class UPPLoad extends UPPExpr {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
        ...
        RTLInst inst = new RTLLoad(regAddr, reg, succ);
        return this.addr.toRTL(locals, globals, regAddr, inst);
    }//toRTL
...
class UPPCond extends UPPInst {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
        ...
        return this.cond.toRTL(locals, globals, regCond, gtz);
    }//toRTL
...
class UPPProcCall extends UPPInst {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, RTLInst succ) {
        ArrayList<PRegister> regs = new ArrayList<>();
        for(UPPExpr e : this.args) {
            regs.add(e.getPRegister(locals));
        }
...
class UPPSeq extends UPPInst {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
        ...
        RTLInst ni1 = this.i1.toRTL(locals, globals, ni2);
        return ni1;
    }//toRTL        
...
class UPPProc extends UPPDef {
    ...
    RTLDef toRTL (ArrayList<String> globals) {
        ...
        RTLInst body = code.toRTL(regTrans,globals,new RTLEnd());
        return new RTLProc(this.name, regArgs, regLocals, body);
    }//toRTL
